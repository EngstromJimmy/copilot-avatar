        ...
        return [
            {
                ...
                handler: async ({ reload = false } = {}) => {
                    try {
                        ...
                        if (!wasOpen) return "Avatar window opened.";
                        return reload ? "Avatar window refreshed." : "Avatar window already open.";
                    } catch (e) {
            ...
            {
                name: `${prefix}_eval`,
                description: "Evaluate JavaScript inside the avatar webview window and return the result.",
                parameters: {
                    type: "object",
                    properties: {
            ...
            {
                name: `${prefix}_close`,
                description: "Close the avatar window if it is open.",
